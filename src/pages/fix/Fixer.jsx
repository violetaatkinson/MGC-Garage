			...
			<section className="bg-[#202020] text-gray-300 px-4 sm:px-6 py-12 sm:py-16">
				<form onSubmit={handleSubmit} className="max-w-5xl mx-auto space-y-6">
					...
					<div className="bg-zinc-900 mt-10 p-6 sm:p-8 border border-zinc-800 rounded-xl">
						...
						<button
							type="submit"
							className="w-full bg-orange-500 mt-10 hover:bg-orange-600 active:bg-orange-700 text-white py-4 tracking-widest font-semibold transition mb-3 rounded-md"
						>
